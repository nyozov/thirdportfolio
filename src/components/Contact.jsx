      ...
      <form className="w-full max-w-lg mt-6">
        ...
        <div className="flex justify-center items-center w-full">
          ...
          >
            ...
            {!loading &&   <svg role="status" class="w-[23.5px] h-[23.5px] mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
