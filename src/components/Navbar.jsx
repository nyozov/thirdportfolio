            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div id="MobileNavigation" className={`${show ? 'block' : 'hidden'} sm:hidden bg-transparent p-6 rounded-full backdrop-blur mt-4 mx-auto`}>
                    ...
                    <div className="flex flex-col gap-4 mt-4 w-80 mx-auto ">
                        <button className="rounded-md flex space-x-2 w-full text-shadow h-10 shadow leading-3 font-semibold text-gray-200 hover:bg-gray-500  border border-gray-200  duration-150 justify-center items-center">Projects</button>
                        <button className="font-semibold text-white px-3 shadow-md flex bg-button justify-center items-center border border-transparent py-2 rounded-md hover:border-gray-200">Contact Me</button>
                    </div>
                </div>
            </nav>
        </div>
