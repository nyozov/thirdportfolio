            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div className="flex justify-between ">
                    ...
                    <div className="hidden sm:flex flex-row space-x-4">
                        <div className="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-indigo-700 bg-white border border-indigo-700 focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">Projects</div>
                        <button className="rounded-md text-white px-3 shadow-md flex bg-gradient-to-br from-purple-400 to-teal-400  hover:from-purple-500 hover:to-teal-500 justify-center items-center">Contact Me</button>
                    </div>
                    {/* Burger Icon */}
