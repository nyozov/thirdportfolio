...
const Projects = () => (
  <div classname="overflow-y-hidden bg-gray-100">
    ...
    <button className="font-semibold text-white p-3 hover:bg-gray-500 shadow-md flex bg-button justify-center w-36 items-center border border-transparent border-gray-200">
      See More
    </button>
